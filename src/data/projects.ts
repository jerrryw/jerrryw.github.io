...
export const projects: readonly Project[] = [
  {
    ...
    title: 'Personal AI Agent (On-Device LLM Inference)',
    summary:
    ...
    stack: ['MLX', 'Apple Silicon', 'FastAPI', 'Swift', 'iOS', 'Llama'],
    highlights: [
  ...
  },
  {
    ...
    title: 'Depth-Based Autonomous Obstacle Avoidance for UAVs',
    summary:
    ...
    stack: ['RL', 'PPO', 'ROS 2', 'Gazebo', 'PX4', 'HPC'],
    highlights: [
  ...
  },
  {
    ...
    title: 'CARLA Autonomous Driving Perception Pipeline',
    summary:
